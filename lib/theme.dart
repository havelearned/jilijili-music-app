...
const MaterialColor primaryColor = MaterialColor(_bluePrimaryValue, <int, Color>{
  50: Color(0xFFFFFFFF),
  100: Color(0xFFCFD4DE),
  200: Color(0xFF98A4E7),
  300: Color(0xFF74747C),
  400: Color(0xFF4765D7),
  500: Color(0xFF5ED983),
  600: Color(_bluePrimaryValue),
  700: Color(0xFFE2E86E),
  800: Color(0xFFC5DC73),
  900: Color(0xFF3A3A3F),
});
